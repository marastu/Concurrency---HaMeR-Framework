...
mUrlEditText=(EditText)findViewById(R.id.url);
    ...
    public void downloadImage(View view) {
        try {
          ...
          //startActivityForResult(new Intent(this, DownloadImageActivity.class), DOWNLOAD_IMAGE_REQUEST);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    protected void onActivityResult(int requestCode,
        ...
        // code.
         			...
         			Toast.makeText(getApplicationContext(), "Unable to start gallery app",Toast.LENGTH_LONG).show();
             	}
    }
    ...
    private Intent makeGalleryIntent(String pathToImageFile) {
        ...
        Uri imageData = Uri.fromFile(file);
			Intent i= new Intent(Intent.ACTION_VIEW);
			        i.setDataAndType(imageData, "image/*");
